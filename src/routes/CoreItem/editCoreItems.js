...
const Edit = (props) => {
    ...
    useEffect(() => {
        ...
        axios({
            url: baseURL+"/fetch-core-items-by-Id/" + id,
            method: "GET",
            headers: {
            ...
            setCoreItem(res.data.coreitems)
    ...
    const onSubmit = (e) => {
      ...
      data.append("core_items_status",coreitem.core_items_status);
      ...
      data.append("core_items_nick_name",coreitem.core_items_nick_name);
        ...
        axios({
            url: baseURL+"/update-core-items/"+id+'?_method=PUT',
            method: "POST",
            data,
            headers: {
            Authorization: `Bearer ${localStorage.getItem("login")}`,
            ...
            if(res.data.code == '200'){
                NotificationManager.success("Core Items Updated Sucessfully");
  ...
  return (
    <div className="textfields-wrapper">
      <PageTitleBar title="Edit Core Item" match={props.match} />
      <RctCollapsibleCard>
        <form id="addIndiv" autoComplete="off" style={{paddingLeft:'10%',paddingRight:'10%'}}>
          ...
          <div className="col-sm-6 col-md-6 col-xl-12">
              ...
              <img src={(coreitem.core_items_image  === null || coreitem.core_items_image === '' ? "https://houseofonzone.com/admin/storage/app/public/no_image.jpg" : "https://houseofonzone.com/admin/storage/app/public/CoreItems/"+coreitem.core_items_image)} style={{width:'180px',height:'180px'}}/>,
              </div>
              </div>
          </div>
            ...
            <div className="col-sm-12 col-md-12 col-xl-4">
              <div className="form-group">
                <TextField
                  ...
                  name="core_items_status"
                  value={coreitem.core_items_status}
                  onChange={(e) => onInputChange(e)}
                  fullWidth
                >
                  {status.map((option) => (
